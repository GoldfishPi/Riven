 ...
 */
public class AutonomousMountainRightSide extends AutonomousVariables {
    ...
    public void setupAutonomous() {
        ...
        addDriveAction(DRIVE_FORWARD, 50 * 45, 0, 1.0, 0.0);
        ...
        addDriveAction(DRIVE_BACKWARD, (-50 * 45), (-50 * 212), -0.13, -1.0);
        addWaitAction((1800));
