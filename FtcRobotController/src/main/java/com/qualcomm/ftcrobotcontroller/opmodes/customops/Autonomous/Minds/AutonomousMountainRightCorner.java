...
public class AutonomousMountainRightCorner extends AutonomousMindContainer {
    ...
    public void setupAutonomous() {
        ...
        addBlockingWinchAction(2400, 0.9);
        addBlockingArmAction(ARM_ACTION, 1300, 0.5);
        addWinchAction(-2300, -0.5);
//        addServoAction(LEFT_SHURIKEN, 0.8); addServoAction(RIGHT_SHURIKEN, 0.5);
//        addDriveAction(DRIVE_FORWARD, 250, 250, 0.2, 0.2);
//        addArmAction(ARM_ACTION, 2140 * 2, 0.5);
