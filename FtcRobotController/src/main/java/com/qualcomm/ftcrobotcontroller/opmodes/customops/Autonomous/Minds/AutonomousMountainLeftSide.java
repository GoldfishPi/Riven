 ...
 *
 * OpMode for Red alliance that starts in the < corner by the driver box.
 */
public class AutonomousMountainLeftSide extends AutonomousMindContainer {
    ...
    public void setupAutonomous() {
        ...
        builder.addDriveAction(DRIVE_FORWARD, 0, (12 * 45), 0.0, 0.2);

        builder.addDriveAction(DRIVE_FORWARD, 1000, 1000, 0.2, 0.2);
        builder.addDriveAction(DRIVE_FORWARD, 0, (-12 * 90), 0.0, -0.2);
        ...
        builder.addCompleteEncoderResetAction();
        builder.addDriveAction(DRIVE_BACKWARD, (-12 * 180), (-12 * 90), -0.4, -0.13);
